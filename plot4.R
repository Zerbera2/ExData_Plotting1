...
## Panel 1: Plot Global Active Power
plot(elec$Time2, elec$Global_active_power, type = "l", 
     ylab = "Global Active Power", xlab = "")

## Panel 2: Voltage
plot(elec$Time2, elec$Voltage, type = "l", ylab = "Voltage", 
     xlab = "datetime")
...
legend("topright", lty = c(1,1), col = c("black", "red", "blue"), 
       legend = names(elec[7:9]), cex = 0.75)

## Panel 4: Global reactive power
with(elec, plot(Time2, Global_reactive_power, type = "l", xlab = "datetime"))
